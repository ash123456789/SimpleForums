...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'users_username_uindex' => ['type' => 'unique', 'columns' => ['username'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
    ...
    public $records = [
        [
            ...
            'role_id' => 1,
            'created' => '2017-07-28 14:04:12',
            'modified' => '2017-07-28 14:04:12'
        ],
    ];
}
